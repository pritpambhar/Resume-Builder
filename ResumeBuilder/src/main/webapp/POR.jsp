...
<body style="background-image: url('images/Reume Builder Images/bg-cover-article-mobile.png');background-size: cover;">
	...
	<div class="container-contact100">
		...
		<button class="contact100-btn-show">
			<i class="" aria-hidden="true">Positions of Responsibility <a>click here</a> </i>
		</button>
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" action="publicProfile.html"> 
				...
				<div class="form-row">
					...
					<div class="col-12">
						<p style="margin-left:85px;"><i>Example : - Contributed as Main Event Coordinator in GTU Techfest-2019.</i></p>
						<br>
					</div>
