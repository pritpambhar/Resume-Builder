...
<body style="background-image: url('images/Reume Builder Images/180509.png');background-size: cover;">
	...
	<div class="container-contact100">
		...
		<button class="contact100-btn-show">
			<i class="" aria-hidden="true">General Information <a>click here</a> </i>
		</button>
		...
		<div class="wrap-contact100">
			...
			<form class="contact100-form validate-form" action="generalInfo" method="post"> 
				...
				<div class="wrap-input100 validate-input" data-validate = "Message is required">
					...
					<input type="text" class="input100" name="address" placeholder="Enter your addess">	
					<span class="focus-input100"></span>
				</div>
